        ...
        <AnimatedSection>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-0 max-w-lg mx-auto">
            <input
              ...
              required
              className="flex-1 bg-dark-200 border border-dark-400 border-r-0 px-5 py-3.5 font-body text-sm text-white placeholder:text-white/30 focus:outline-none focus:border-gold transition-colors"
            />
            <button
              type="submit"
              disabled={loading}
              className="bg-gold hover:bg-gold-light text-dark font-mono text-xs tracking-widest uppercase px-8 py-3.5 transition-all duration-300 shrink-0 disabled:opacity-50 disabled:cursor-not-allowed"
            >
