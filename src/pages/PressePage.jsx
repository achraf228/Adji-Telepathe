...
import { AnimatedSection, GoldButton, OutlineButton } from '@/components/ui'
    ...
    <>
      ...
      <section className="py-24">
        <div className="max-w-5xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
            ...
            <AnimatedSection>
              <div className="card-dark p-8 relative overflow-hidden">
                ...
                <div className="font-display text-5xl text-gold/20 mb-4">PDF</div>
                ...
                <GoldButton href={PRESS_KIT_URL} external>
            ...
            <AnimatedSection delay={100}>
              <div className="card-dark p-8 relative overflow-hidden">
                <div className="absolute top-0 right-0 w-32 h-32 bg-gold/5 rounded-full -translate-y-16 translate-x-16" />
                <div className="font-display text-5xl text-gold/20 mb-4">IMG</div>
                ...
                <OutlineButton href={PRESS_PHOTOS_URL} external>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
            <AnimatedSection>
              <div className="border-l-2 border-gold pl-6">
                <h3 className="font-mono text-xs tracking-widest text-gold uppercase mb-4">{t('press.bio_short')}</h3>
            ...
            <AnimatedSection delay={100}>
              <div className="border-l-2 border-dark-400 pl-6">
                <h3 className="font-mono text-xs tracking-widest text-gold uppercase mb-4">{t('press.bio_long')}</h3>
                <p className="font-body text-sm text-white/70 leading-relaxed">
          ...
          {/* Press Contact */}
          <AnimatedSection>
            <div className="bg-dark-200 border border-gold/20 p-8 text-center">
              <h3 className="font-mono text-xs tracking-widest text-gold uppercase mb-6">{t('press.contact_press')}</h3>
