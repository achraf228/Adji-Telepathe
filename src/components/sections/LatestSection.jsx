...
export default function LatestSection() {
  ...
  return (
    <section className="py-24 bg-dark-100 relative overflow-hidden">
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_80%_50%,rgba(34,211,238,0.06),transparent_60%)]" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <AnimatedSection>
            <div className="relative aspect-square max-w-sm mx-auto lg:mx-0">
              <div className="absolute -inset-4 border border-cyan-400/20 z-0" />
              <div className="absolute -inset-8 border border-cyan-400/10 z-0" />
              {LATEST.cover ? (
                <img
                  src={LATEST.cover}
                  alt={LATEST.title}
                ...
                <div className="w-full h-full bg-dark-300 flex items-center justify-center relative z-10"> 
                  <span className="font-display text-6xl text-cyan/20">♪</span>
                </div>
              )}
            </div>
          </AnimatedSection>
          ...
          <AnimatedSection delay={200}> 
            ...
            <div className="flex flex-wrap gap-4">
              <CyanButton 
                ...
                external 
                className="bg-transparent border border-cyan text-cyan hover:bg-[#1DB954] hover:border-[#1DB954] hover:text-white transition-all duration-300"
              >
                Spotify
              </CyanButton>
              <CyanButton href={LATEST.youtubeUrl} external className="bg-transparent border border-cyan text-cyan hover:bg-red-600 hover:border-red-600 hover:text-white transition-all duration-300">
                 YouTube
              </CyanButton>
            </div>
          </AnimatedSection>
